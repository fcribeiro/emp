...
class EmpServerApi(object):
    ...
    def application_scale_app(self, app_id, replicas, **kwargs):  # noqa: E501
        """Changes an application state  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.application_scale_app(app_id, replicas, async=True)
        >>> result = thread.get()

        :param async bool
        :param str app_id: ID of the application to change its state (required)
        :param int replicas: Number of Replicas (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.application_scale_app_with_http_info(app_id, replicas, **kwargs)  # noqa: E501
        else:
            (data) = self.application_scale_app_with_http_info(app_id, replicas, **kwargs)  # noqa: E501
            return data

    def application_scale_app_with_http_info(self, app_id, replicas, **kwargs):  # noqa: E501
        """Changes an application state  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.application_scale_app_with_http_info(app_id, replicas, async=True)
        >>> result = thread.get()
        ...
        all_params = ['app_id', 'replicas']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method application_scale_app" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'app_id' is set
        if ('app_id' not in params or
                params['app_id'] is None):
            raise ValueError("Missing the required parameter `app_id` when calling `application_scale_app`")  # noqa: E501
        # verify the required parameter 'replicas' is set
        if ('replicas' not in params or
                params['replicas'] is None):
            raise ValueError("Missing the required parameter `replicas` when calling `application_scale_app`")  # noqa: E501
