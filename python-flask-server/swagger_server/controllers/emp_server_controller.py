...
import swagger_server.controllers.kub_controller as kub
...
def application_change_app_state(app_id, state):  # noqa: E501
    ...
    return kub.change_app_state(app_id, state)
...
def application_get_app_tracing(app_id):  # noqa: E501
    ...
    :rtype: str
    """
    return kub.get_app_tracing(app_id)
